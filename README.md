...
[Ссылка на проект](https://github.com/wiky-avis/Auth_sprint_1)
...
На этом этапе получаем данные о пользователя от провайдера, создаем верменного пользователя. Далее пользователю 
...
### Управление ролями(сервисные ручки)
